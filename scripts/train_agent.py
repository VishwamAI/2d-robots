...
policy_saver = policy_saver.PolicySaver(agent.policy, batch_size=None, signatures={'serving_default': agent.policy.action.get_concrete_function(time_step=time_step_placeholder)})
